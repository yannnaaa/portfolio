/*let itemsButton = document.querySelector('.button-mobile');
//console.log(itemsButton);

itemsButton.addEventListener('click', function() {
  var text = document.querySelector('.test').firstChild;
  var p = document.createElement('P');
  text.parentNode.insertBefore(p, text);
  p.appendChild(text);


  //let elHtml = document.querySelector('html').style.width = '640px';
  let elBody = document.querySelector('.wrapper');
  let newEl = document.createElement('div');
  newEl.classList.add('container');
//  let newEl = document.createElement('div').setAttribute('class') = 'container';
  elBody.parentNode.insertBefore(newEl, elBody);
  newEl.appendChild(elBody);
